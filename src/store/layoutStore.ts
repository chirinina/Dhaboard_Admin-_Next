...
export type AppBackground = "default" | "slate" | "zinc" | "stone" | "blue";
  ...
  devtools(
    persist(
      (set) => ({
        ...
        accentColor:
          (APP_DEFAULTS as { accentColor?: AccentColor }).accentColor ?? "blue",
        setAccentColor: (accentColor) => set(() => ({ accentColor })),
        appBackground:
          (APP_DEFAULTS as { appBackground?: AppBackground }).appBackground ??
          "default",
