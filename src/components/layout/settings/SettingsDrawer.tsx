...
import { BackgroundColorSection } from "./parts/BackgroundColorSection";
import { ColorPickerSection } from "./parts/ColorPickerSection";
...
export const SettingsDrawer = ({
  ...
  return (
    <Drawer direction="right" open={open} onOpenChange={setOpen} noBodyStyles>
      ...
      <DrawerContent
        className="!bg-primaryBg max-xsm:!w-full sm:!max-w-[340px]"
      ...
      >
        ...
        >
          <div className="flex flex-col min-h-full">
            ...
            <div className="hidden xl:block px-5 py-4">
              <div className="flex items-center justify-between">
                <Label className="text-sm font-medium tracking-wide text-primaryText">
                  {t("fixedNavbar")}
                </Label>
