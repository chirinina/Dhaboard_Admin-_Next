        ...
        <TooltipTrigger asChild>
          ...
          >
            <button
              ...
              className="relative text-base flex rounded-full justify-center items-center gap-2 w-full h-full border border-mainBorder hover:bg-navbarIconButtonBgHover text-primaryText stroke-grayIcon fill-grayIcon"
              type="button"
