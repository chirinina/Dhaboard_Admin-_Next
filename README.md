...
<div align="center">
  <a href="https://github.com/Diolay/Diolay/blob/main/CHANGELOG.md" style="text-decoration: none;">
    <img src="https://img.shields.io/badge/%20-changelog-blue?logo=readme&logoColor=white&labelColor=grey" alt="Changelog" />
  </a>
  <a href="https://github.com/Diolay/Diolay/blob/main/license" style="text-decoration: none;">
    <img src="https://img.shields.io/badge/license-MIT-blue" alt="License" />
  </a>
  <a href="https://github.com/Diolay/Diolay/releases" style="text-decoration: none;">
    <img src="https://img.shields.io/github/package-json/v/Diolay/Diolay?color=green" alt="Version" />
  </a>
</div>
...
<div align="center">
  <img src="https://github.com/user-attachments/assets/d143f2da-8aec-4a5d-914a-46f15aadf2d4" alt="Diolay Dashboard" width="800" />
</div>

## Overview

Diolay is a free, open-source dashboard starter designed for building modern SaaS products, internal tools and data-rich admin panels. It provides the UI components, pages and patterns you need to create a complete dashboard application - available out of the box.

It will give you a solid head start and save a lot of development time by serving as a practical foundation that you can easily extend and adapt to your specific needs. The project runs as a standalone frontend by default, ready to be integrated with your own API or an optional Diolay backend that enables a production-ready authentication flow.
...
You can get started with Diolay by cloning the repository:
...
Diolay starter is designed to work as a standalone front-end application by default. It loads mock data from `public/backendBackup.json` and has routes protection disabled.
...
#### Live demo [https://demo.Diolay.com/](https://demo.Diolay.com/)

#### Additional resources

- [Storybook](https://storybook.Diolay.com/)
- [Authentication docs](https://auth.Diolay.com/)
- [Node.js backend](https://github.com/Diolay/Diolay-backend)

#### Lightweight version

- [Live demo](https://layout.Diolay.com/)
- [Repository](https://github.com/Diolay/Diolay-layout)
...
Clone and run the [Diolay Backend](https://github.com/Diolay/Diolay-backend)
...
For remote hosting, you can easily deploy your own instance of Diolay dashboard on Vercel using the link below.

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/Diolay/Diolay)
...
Check out [CONTRIBUTING.md](https://github.com/Diolay/Diolay/blob/main/CONTRIBUTING.md) to learn how to get started with contributions.
...
Subscribe to the [Diolay newsletter](https://Diolay.kit.com/) to get notified about major updates and new features.
